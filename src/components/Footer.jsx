...
const social = [
  {
    name: "Instagram",
    href: "https://instagram.com/avanzacapital.mx",
    icon: (
  ...
  {
    name: "Facebook",
    href: "https://facebook.com/avanzacapital",
    icon: (
      <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
...
export default function Footer() {
  return (
    <footer style={{
      ...
      background: "linear-gradient(180deg, transparent 0%, rgba(66,15,93,0.2) 100%)",
      borderTop: "1px solid rgba(168,85,247,0.12)",
    }}>
      {/* Top strip */}
      <div style={{
        background: "linear-gradient(90deg, #420F5D, #6B21A8, #FF4B7C, #6B21A8, #420F5D)",
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{
              ...
              fontSize: "0.88rem", lineHeight: 1.7, marginBottom: 20,
            }}>
            ...
            <div style={{ display: "flex", gap: 12 }}>
              {social.map(s => (
                <a
                  ...
                  onMouseEnter={e => {
                    e.currentTarget.style.background = "rgba(255,75,124,0.2)";
                    e.currentTarget.style.borderColor = "#FF4B7C";
                    e.currentTarget.style.color = "#FF4B7C";
                  }}
                  onMouseLeave={e => {
              ...
              {links.map(l => (
                <li key={l.label}>
                  <a
                    ...
                    onMouseEnter={e => e.currentTarget.style.color = "#FF4B7C"}
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              {[
                { icon: "📍", text: "Tijuana & Ensenada, Baja California" },
                { icon: "📞", text: "+52 664 123 4567" },
                { icon: "✉️", text: "contacto@avanzacapital.mx" },
              ].map(c => (
                <div key={c.text} style={{ display: "flex", gap: 10, alignItems: "flex-start" }}>
                  <span style={{ fontSize: 15, marginTop: 1 }}>{c.icon}</span>
                  <span style={{ color: "rgba(255,255,255,0.4)", fontFamily: "Inter, sans-serif", fontSize: "0.88rem", lineHeight: 1.5 }}>{c.text}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div style={{
              background: "linear-gradient(135deg, rgba(255,75,124,0.15), rgba(168,85,247,0.15))",
              border: "1px solid rgba(255,75,124,0.25)",
              borderRadius: 16, padding: "20px",
            }}>
              <div style={{
                fontFamily: "Montserrat, sans-serif", fontWeight: 900,
                fontSize: "1.3rem", color: "white", marginBottom: 6,
              }}>
            ...
            <div style={{
              ...
              <div>
                <div style={{ color: "white", fontFamily: "Montserrat, sans-serif", fontWeight: 700, fontSize: "0.85rem" }}>Respaldados por GNP</div>
                <div style={{ color: "rgba(255,255,255,0.35)", fontFamily: "Inter, sans-serif", fontSize: "0.75rem" }}>Aseguradora #1 de México</div>
              </div>
            </div>
          </div>
        </div>
